...
function getTriviaResults(userObj) {
  // need to adjust schema to incorporate new quiz question re: trivia category

  // animals is 27, sports is 21, computer science 18
  // celebrities 26, history 23, politics 24, science/nature 17

  let category;

  switch (userObj.interest) {
